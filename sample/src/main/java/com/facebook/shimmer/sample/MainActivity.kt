...
class MainActivity : Activity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toggleButtons = arrayOf(
                ...
                slow_and_reverse_toggle_button,
                thin_straight_and_transparent_toggle_button,
                sweep_angle_90_toggle_button,
                spotlight_toggle_button
        )
//        toggleButtons.forEach { it.setOnClickListener(this@MainActivity) }
//        selectPresetToggle(0, false)
    }

    override fun onClick(v: View) {
        selectPreset(presetButtons.indexOf(v as Button), true)
//        selectPresetToggle(toggleButtons.indexOf(v as ToggleButton), true)
    }
